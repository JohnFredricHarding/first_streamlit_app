...
# Let's put a pick list here so they can pick the fruit tey want to include
...
#Next row just lists the information from the response as one long string ie Just writes data to the screen
